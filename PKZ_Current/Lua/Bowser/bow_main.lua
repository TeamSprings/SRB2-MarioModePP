...
local function cutsceneBowser(mo)
	...
	if leveltime == TICRATE*8 then
		...
		print("Period of cutscene ended")
	else
...
local function bowserArenaTrap(mo, line)
	...
	if line.frontsector and not line.backsector return true end -- I'm writing this with a massive headache, consider not judging me yet
	if line.backsector and not line.frontsector return true end
